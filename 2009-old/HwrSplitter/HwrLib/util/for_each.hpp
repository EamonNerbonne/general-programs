...
//| Fancy iteration over collections                                           |
//|                                                                            |
...
// ----------------------------------------------------------------------------- : Typeof magic
	...
	#define DECLARE_TYPEOF(T)               enum {}
	#define DECLARE_TYPEOF_NO_REV(T)        enum {}
	#define DECLARE_TYPEOF_CONST(T)         enum {}
	#define DECLARE_TYPEOF_CONST_NO_REV(T)  enum {}
	#define DECLARE_TYPEOF_COLLECTION(T)    enum {}
	...
	/// Declare typeof magic for a specific type, using const iterators
	#define DECLARE_TYPEOF_CONST_NO_REV(T)                              \
	    template<> struct TypeOf<typeid(T)> {                           \
	        typedef T               type;                               \
	        typedef T::const_iterator       const_iterator;             \
	        typedef T::const_reference      const_reference;            \
