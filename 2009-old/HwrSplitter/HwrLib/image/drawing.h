...
void draw_x_projection(PamImage<RGBPixel>& im, int x0, int x1, const std::vector<double>& histo, RGBPixel color, float alpha = 0.7);
/// Draw a x-projection histogram
void draw_y_projection(PamImage<RGBPixel>& im, int y0, int y1, const std::vector<double>& histo, RGBPixel color, float alpha = 0.7);
