...
namespace CharWidthAnalysis {
    class Program {
        ...
        private void Exec() {
            ...
            FileInfo charLengthFile = new FileInfo( System.IO.Path.Combine(DataIO.Program.DataPath, "char-width.txt"));
        ...
        IEnumerable<MeasuredWord> GetUsefulWords() {
            ...
            foreach (int pagenum in wordImagesByPage.Keys) {
                WordsImage userAnnot = wordImagesByPage[pagenum], 
					machineAnnot = annotImagesByPage[pagenum];
