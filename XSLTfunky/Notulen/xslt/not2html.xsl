...
<xsl:template match="notulen">
 <html><!-- xmlns="http://www.w3.org/1999/xhtml"-->
  <head>
   ...
   <title>Notulen van <xsl:value-of select="head/date"/></title>
  </head>
  <body>
...
<xsl:template match="head">
 <h1>Vergadering Lustrumcommissie 2002</h1>
 <p>
  <table class="wwwtab"><tbody>
   <tr><td class="www">Waneer:</td><td class="wwwdata"><xsl:value-of select="date"/></td></tr>
   <tr><td class="www">Waar:</td><td class="wwwdata"><xsl:value-of select="place"/></td></tr>
   <tr><td class="www">Wie:</td><td class="wwwdata"><xsl:value-of select="people"/></td></tr>
  </tbody></table>
 </p>
