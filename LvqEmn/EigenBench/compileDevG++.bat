...
g++ -I "C:\Program Files (Custom)\boost_1_41_0" -I "C:\Program Files (Custom)\eigen" -march=native -mtune=native -O3 -DEIGEN_DONT_VECTORIZE -DNDEBUG -o benchDev DoTest.cpp learningBench.cpp main.cpp mulBench.cpp 
