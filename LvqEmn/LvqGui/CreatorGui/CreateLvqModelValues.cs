	...
	public class CreateLvqModelValues : HasShorthandBase, IHasSeed {
		...
		public int Dimensionality {
			...
			set {
				...
				if (settings.ModelType != LvqModelType.Lgm && settings.ModelType != LvqModelType.Lpq && settings.ModelType != LvqModelType.Normal && settings.ModelType != LvqModelType.Gm && value != 2 && value != 0) throw new ArgumentException("2D Projection models must have exactly 2 internal dimensions.");
