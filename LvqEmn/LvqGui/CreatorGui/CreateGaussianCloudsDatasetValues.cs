...
namespace LvqGui
{
    ...
    public class CreateGaussianCloudsDatasetValues : HasShorthandBase, IHasSeed
    {
        ...
        public GaussianCloudDatasetSettings Settings { get => settings; set { if (settings != value) { settings = value; AllPropertiesChanged(); } } }
        ...
        public override string Shorthand { get => settings.Shorthand; set { settings.Shorthand = value; _propertyChanged("Shorthand"); } }
